...
RobotAutomat = function(config) {
    ...
    function onOpen() {
        ...
        checkDeviceSupport(function() {
            ...
            console.log('Robot > devices: ' + JSON.stringify(devices));
        });
    }
    ...
    function createPeer(device) {
        if (typeof  device !== 'undefined') {
            ...
            var peer = new OfferPeer(peer_config);
            ...
            var video_device = (typeof device.video_device !== 'undefined') ? device.video_device : false;
            var mic_id = (typeof audio_device.arr_id !== 'undefined') ? _devices[audio_device.arr_id].id : false;
            var cam_id = (typeof video_device.arr_id !== 'undefined') ? _devices[video_device.arr_id].id : false;
            var dev_config = {
